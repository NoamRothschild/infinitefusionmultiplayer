...
require_relative "connection_mixin"
require_relative "ruby_connection/buffered_io"
require_relative "ruby_connection/resp3"
...
class RedisClient
  class RubyConnection
    ...
    def connect
      ...
      puts "ERROR on D:/Program-Files/PokemonEssentials/inf-fusion/kurayshinyrevamp/Libs/redis-client-0.22.2/lib/redis_client/ruby_connection.rb:155 - #{error}"
      #SystemCallError, OpenSSL::SSL::SSLError, SocketError
      socket&.close
